          ...
          >
            <DialogPanel class="w-full max-w-4xl transform overflow-hidden rounded-2xl bg-white dark:bg-gray-800 p-6 text-left align-middle shadow-xl transition-all">
              ...
              <div v-if="loading" class="flex justify-center py-8">
                <svg class="animate-spin h-10 w-10 text-rose-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                    ...
                    <tr v-for="action in actions" :key="action.id">
                      ...
                      <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <button
                          ...
                          class="text-rose-600 hover:text-rose-900 dark:text-rose-400 dark:hover:text-rose-300 mr-3"
                        >
                          Düzenle
                        </button>
                        <button
